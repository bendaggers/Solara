#!/usr/bin/env python3
"""
Test script for Dummy Predictor
Run this to verify the dummy predictor works without MT5
"""
import sys
import os
import pandas as pd
...
def test_dummy_predictor():
    ...
    # Note: We can't easily instantiate ModelRegistryEntry due to Pydantic validation
    # So we'll test the predictor directly with a simple mock object
    ...
    print(f"✓ Predictor requires {len(features)} features")
    print(f"  Sample features: {features[:5]}...")
    
    # Create test dataframe
    df = create_test_dataframe()
    print(f"✓ Created test dataframe with {len(df)} symbols")
...
if __name__ == "__main__":
    ...
    if test1_ok and test2_ok:
        print("\n✓ All tests passed! Dummy predictor is ready for testing.")
        print("\nNext steps:")
